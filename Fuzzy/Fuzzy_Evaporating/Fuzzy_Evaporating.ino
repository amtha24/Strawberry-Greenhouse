float suError  []={17,17,22, 18,23,26, 25,30,30};
              //  Zero         PK          PB
...
float sDefuzz()   //COG
{
  ...
  Serial.print ("Vout = "); Serial.println(sVout);
}
void setup() 
{
  Serial.begin(9600);
  sEvalue = 17;      //input error
  sDevalue = -5 ;   //input delta error
