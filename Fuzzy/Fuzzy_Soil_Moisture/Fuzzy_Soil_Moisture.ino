...
{
    Serial.begin(9600);
  Evalue = 4.2;      //input error
  Devalue = 0 ;   //input delta error
  
  //rule___________________________________________________________________________
  DerrMin = udError[0];
  if (Devalue <= DerrMin)
  {
    Devalue = DerrMin;
