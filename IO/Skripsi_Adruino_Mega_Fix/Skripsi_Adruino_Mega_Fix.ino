...
void soilmoisture()
{
  ...
  soilval = map(soilanalog,423,360,1,2);
  Evalue = soilval;
  Serial.print("soil");Serial.println(soilanalog);
...
void LDR()
 {
  ...
  L = map(LDRanalog, 163, 94, 600, 1500);
   Serial.print("LDR");Serial.println(LDRanalog);
