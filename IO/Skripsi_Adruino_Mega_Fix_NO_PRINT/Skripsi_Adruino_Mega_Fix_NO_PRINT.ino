...
void Dht22()// suhu belum aktif
{
  ...
  t = temp - 8; int tt = t+5; //Serial.println(tt); // -3
...
void soilmoisture()
{
  ...
  soilval = map(soilanalog,525,700,35,90);// coba kanan kurangi 20
  ...
  lcd.setCursor(17,0);lcd.print (soilval);
    Evalue = soilval;// soil val bagi 10 
  //Serial.print("soilmoist:");Serial.println(soilval);
...
void LDR()
 {
  ...
  L = map(LDRanalog, 55, 35, 6000, 15000);
